...
[![version](https://img.shields.io/badge/version-v1.0.4-blue.svg)](https://github.com/GBear09/passable-status-summary-card/releases)
...
4. Click **Add Resource** and set:
   - **Url**: `/local/passable-status-summary-card.js?v=1.0.4`
